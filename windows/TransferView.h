    ...
    private:
        ...
        class ItemInfo : public UserInfoBase
        {
            public:
                ...
                {
                    return static_cast<uint8_t>(!download ? IMAGE_UPLOAD : (!parent ? IMAGE_DOWNLOAD : IMAGE_SEGMENT));
                }
        ...
        struct UpdateInfo : public Task
        {
                ...
                {
                    return download == ii.download && user == ii.user;
                }
                ...
                tstring statusString;
                void setTarget(const tstring& aTarget)
                {
                    target = aTarget;
                ...
                {
                    IP = aIP;
                    flagIndex = aFlagIndex, updateMask |= MASK_IP;
                }
                tstring IP;
        ...
        void speak(uint8_t type, UpdateInfo* ui)
        {
