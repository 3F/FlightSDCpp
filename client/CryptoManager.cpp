...
{
    *priv = new CriticalSection();
    return 0;
}
static int mutex_destroy(void **priv)
{
    delete *priv;
    *priv = NULL;
    return 0;
}
static int mutex_lock(void **priv)
{
    ((CriticalSection*)(*priv))->enter();
    return 0;
}
static int mutex_unlock(void **priv)
{
    ((CriticalSection*)(*priv))->leave();
    return 0;
}
