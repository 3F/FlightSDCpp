...
enum Strings   // @DontAdd
{
    ...
    LIB_CRASH, // "Application ""%s"" caused an unhandled exception in StrongDC++ sqlite. Please uninstall it, upgrade it or use an alternate product."
    LIMIT, // "Upload Limit"
    ...
    MBITSPS, // "MBits/s"
    MBPS, // "MiB/s"
    MENU_ABOUT, // "About StrongDC++ sqlite"
    ...
    MENU_HOMEPAGE, // "StrongDC++ sqlite Homepage"
    MENU_SOURCE_CODE, // "StrongDC++ sqlite source code"
    ...
    SETTINGS_DISPLAY_DC_UPDATE, // "Don't announce new StrongDC++ versions"
