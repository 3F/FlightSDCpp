...
SettingsManager::SettingsManager()
{
    ...
    setDefault(HUBLIST_SERVERS, "http://dchublist.ru/hublist.xml.bz2;http://dchublist.com/hublist.xml.bz2;http://www.hublista.hu/hublist.xml.bz2;http://hublist.openhublist.org/hublist.xml.bz2;");
    ...
    setDefault(LOG_FORMAT_WEBSERVER, "%Y-%m-%d %H:%M: %[ip] tried getting %[file]");
